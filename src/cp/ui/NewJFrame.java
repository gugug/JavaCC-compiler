...
import cp.fileUtil.FileTools;
import cp.fileUtil.MyPrintStream;
import cp.grammer.MyNewGrammar;
import cp.jpy.JPyUtil;
...
public class NewJFrame extends javax.swing.JFrame {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		inputStr = jTextArea2.getText();
		InputStream in = new ByteArrayInputStream((inputStr + ";").getBytes());
		MyNewGrammar.ReInit(in);
		StringBuffer sb = new StringBuffer("\u8f93\u5165:\n" + inputStr + "\n");
		jTextArea3.setText(sb.toString());
		System.out.println(sb.toString());
		// 写到到文本中
		String inSrc = "input.txt";
		FileTools.savaFile(jTextArea2, inSrc);

		/**
		 * 此处调用语法分析器，如果ok则运行文件输出结果
		 * 
		 */
		try {
			...
			case 0:
				...
				sb.append("编译：OK.\n");
				jTextArea3.setText(sb.toString());
				if(sb.indexOf("print")>0){
					sb.append("输出：\n");
					jTextArea3.setText(sb.toString());
					try{
						// 改变输出流，py执行结果输出到这个位置
						FileTools.changeSystemOut("pyresult.txt");
						// 执行py文件
						JPyUtil.execPYFile(inSrc);
						// 读取文本，显示在文本区域
						FileTools.readFile(jTextArea3, "pyresult.txt");
					}catch(Exception e){
						System.out.println("Output NOK...may be runtime error");
						sb.append("Output NOK...may be runtime error(valiable is not defined).\n");
						jTextArea3.setText(sb.toString());
					}
				}
				break;
