...
/*               四则运算                                            */
/*************************************/
  final public String calculator() throws ParseException, NumberFormatException {
        double previousValue=0.0;
    label_2:
    while (true) {
      previousValue = Expression(previousValue);
                        {if (true) return Double.toString(previousValue);}
      if (jj_2_9(3)) {
        ;
      } else {
        break label_2;
  ...
  final public double Expression(double previousValue) throws ParseException, NumberFormatException {
        double i ;
        double value ;
  ...
  final public double Term(double previousValue) throws ParseException, NumberFormatException {
        double i ;
        double value ;
  ...
  final public double Primary(double previousValue) throws ParseException, NumberFormatException {
        Token t=null ;
        double d ;
    if (jj_2_16(3)) {
      ...
      d = Expression(previousValue);
      jj_consume_token(RPARENT);
          {if (true) return d ;}
    } else if (jj_2_20(3)) {
      t = jj_consume_token(MINUS);
      d = Primary(previousValue);
          {if (true) return -d ;}
    } else if (jj_2_21(3)) {
      t = jj_consume_token(VARIABLE);
                {if (true) return Double.parseDouble(SymbolMap.get(t.image));}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
...
/************************************/
  final public void forStatement() throws ParseException {
    ...
    num1 = jj_consume_token(DIGITS);
    jj_consume_token(COMMA);
    num2 = jj_consume_token(DIGITS);
    jj_consume_token(RPARENT);
    jj_consume_token(COLON);
    jj_consume_token(LBRACE);
    jj_consume_token(EOL);
...
*返回类型�?"true"�?"false"
*/
  final public String compareStatement() throws ParseException {
        String t="";
        String i="";
        String j="";
        Token token_i=null;
    ...
    if (jj_2_29(3)) {
      ...
      token_i = jj_consume_token(VARIABLE);
                                       i=SymbolMap.get(token_i.image);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
    ...
    if (jj_2_31(2)) {
      ...
      token_j = jj_consume_token(VARIABLE);
                                       j=SymbolMap.get(token_j.image);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
                        if(t.equals("<"))
                                { {if (true) return Boolean.toString(Double.parseDouble(i)<Double.parseDouble(j)) ;} }
                        else if(t.equals("=="))
                                { {if (true) return Boolean.toString(Double.parseDouble(i)==Double.parseDouble(j));} }
                        else if(t.equals(">"))
                                { {if (true) return Boolean.toString(Double.parseDouble(i)>Double.parseDouble(j));} }
  ...
  final public String comparison_symbol() throws ParseException {
        String symbol="";
    if (jj_2_33(3)) {
      jj_consume_token(BIGGER);
            symbol=">";{if (true) return symbol;}
    } else if (jj_2_34(3)) {
  ...
  final public boolean conditionStatement() throws ParseException {
        String value;
        boolean bool;
    if (jj_2_38(3)) {
...
/*              print语句                                      */
/************************************/
/*print 变量�?*//*print 运算表达�?*//*print 比较语句*//*print 数字*/
/*print 包含变量名的运算表达�?*/
  final public String print() throws ParseException {
        String value="";
        Token t;
    jj_consume_token(PRINT);
    if (jj_2_42(3)) {
      t = jj_consume_token(STRING);
                              value=t.image;{if (true) return value;}
    } else if (jj_2_43(3)) {
      value = compareStatement();
                                            {if (true) return value;}
    } else if (jj_2_44(3)) {
      t = jj_consume_token(VARIABLE);
                               value=SymbolMap.get(t.image);{if (true) return value;}
    } else if (jj_2_45(3)) {
      value = calculator();
                                      {if (true) return value;}
    } else {
...
/*              赋�?�语�?                                          */
/************************************/
/*只能赋�?�double型�?�计算式、string�?*/
  final public void assignment() throws ParseException {
        Token variable_name=null;
        String variable_value="";
        Token variable_value2=null;
    variable_name = jj_consume_token(VARIABLE);
    jj_consume_token(EQUALS);
    if (jj_2_46(10)) {
      variable_value2 = jj_consume_token(STRING);
